...
import { paymentsCreateController, paymentsDeleteController,paymentMethodActiveController, paymentMethodInactiveController, paymentsGetAllController, paymentsGetByIdController, paymentsUpdateController } from "../dependencies";
