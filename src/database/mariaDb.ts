...
const DB_USER = 'admin'; // Cambia esto por tu nombre de usuario
const DB_DATABASE = 'FdezDev'; // Cambia esto por el nombre de tu base de datos
const DB_PASSWORD = 'yeremi224'; // Cambia esto por tu contraseña
